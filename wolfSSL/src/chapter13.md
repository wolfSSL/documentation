...
4. wolfSSL is dual licensed under both the GPLv3 as well as a commercial license, where OpenSSL is available only under their unique license from multiple sources.
